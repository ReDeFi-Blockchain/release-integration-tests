...
import type { BTreeMap, Bytes, Null, Option, Struct, U256, Vec, bool, u128, u32, u64 } from '@polkadot/types-codec';
import type { AnyNumber, ITuple } from '@polkadot/types-codec/types';
import type { AccountId32, H160, H256 } from '@polkadot/types/interfaces/runtime';
import type { CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot, CumulusPalletParachainSystemUnincludedSegmentAncestor, CumulusPalletParachainSystemUnincludedSegmentSegmentTracker, CumulusPrimitivesCoreAggregateMessageOrigin, EthereumBlock, EthereumLog, EthereumReceiptReceiptV3, EthereumTransactionTransactionV2, FpRpcTransactionStatus, FrameSupportDispatchPerDispatchClassWeight, FrameSystemAccountInfo, FrameSystemCodeUpgradeAuthorization, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, PalletBalancesAccountData, PalletBalancesAdapterAccountPermissions, PalletBalancesBalanceLock, PalletBalancesIdAmount, PalletBalancesReserveData, PalletEvmAssetsAccountPermissions, PalletEvmAssetsAssetDetails, PalletEvmAssetsAssetMetadata, PalletEvmAssetsAssets, PalletEvmCodeMetadata, PalletMessageQueueBookState, PalletMessageQueuePage, PalletTransactionPaymentReleases, PalletTreasuryProposal, PalletTreasurySpendStatus, PalletXcmQueryStatus, PalletXcmRemoteLockedFungibleRecord, PalletXcmVersionMigrationStage, PolkadotCorePrimitivesOutboundHrmpMessage, PolkadotPrimitivesV6AbridgedHostConfiguration, PolkadotPrimitivesV6PersistedValidationData, PolkadotPrimitivesV6UpgradeGoAhead, PolkadotPrimitivesV6UpgradeRestriction, RedefiRuntimeRuntimeHoldReason, SpConsensusAuraSr25519AppSr25519Public, SpRuntimeDigest, SpTrieStorageProof, SpWeightsWeightV2Weight, XcmVersionedAssetId, XcmVersionedLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    readonly id: RedefiRuntimeRuntimeHoldReason;
    ...
    balancesAdapter: {
      allowance: AugmentedQuery<ApiType, (arg1: H160 | string | Uint8Array, arg2: H160 | string | Uint8Array) => Observable<u128>, [H160, H160]> & QueryableStorageEntry<ApiType, [H160, H160]>;
      permissions: AugmentedQuery<ApiType, (arg: H160 | string | Uint8Array) => Observable<PalletBalancesAdapterAccountPermissions>, [H160]> & QueryableStorageEntry<ApiType, [H160]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    evmAssets: {
      approvals: AugmentedQuery<ApiType, (arg1: u128 | AnyNumber | Uint8Array, arg2: H160 | string | Uint8Array, arg3: H160 | string | Uint8Array) => Observable<u128>, [u128, H160, H160]> & QueryableStorageEntry<ApiType, [u128, H160, H160]>;
      /**
       * Details of an asset.
       **/
      asset: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletEvmAssetsAssetDetails>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       * Balances
       **/
      balances: AugmentedQuery<ApiType, (arg1: u128 | AnyNumber | Uint8Array, arg2: H160 | string | Uint8Array) => Observable<u128>, [u128, H160]> & QueryableStorageEntry<ApiType, [u128, H160]>;
      /**
       * Metadata of an asset.
       **/
      metadata: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletEvmAssetsAssetMetadata>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      permissions: AugmentedQuery<ApiType, (arg1: u128 | AnyNumber | Uint8Array, arg2: H160 | string | Uint8Array) => Observable<PalletEvmAssetsAccountPermissions>, [u128, H160]> & QueryableStorageEntry<ApiType, [u128, H160]>;
      supportedAssets: AugmentedQuery<ApiType, () => Observable<PalletEvmAssetsAssets>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    privateBalancesAuraExt: {
      authorities: AugmentedQuery<ApiType, () => Observable<Vec<SpConsensusAuraSr25519AppSr25519Public>>, []> & QueryableStorageEntry<ApiType, []>;
      trustedAuthorities: AugmentedQuery<ApiType, () => Observable<Vec<SpConsensusAuraSr25519AppSr25519Public>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
